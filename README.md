...
(function() {
    ...
    const TranslitModule = {
        ...
        'Alla': 'Алла', 'Anya': 'Аня', 'Bazylia': 'Базилія', 'Biljana': 'Біл\'яна', 'Bogna': 'Богна', 'Borislava': 'Борислава', 'Božena': 'Божена', 'Branislava': 'Бранислава', 'Branka': 'Бранка', 'Bratislava': 'Братислава', 'Bronislava': 'Бронислава', 'Bronisława': 'Броніслава', 'Danka': 'Данка', 'Daria': 'Дарія', 'Dobroniega': 'Доброньєга', 'Dorota': 'Дорота', 'Doubravka': 'Добрівка', 'Dragana': 'Драгана', 'Dragica': 'Драгіца', 'Dunja': 'Дуња', 'Dusa': 'Дуса', 'Ekaterina': 'Єкатерина', 'Gaja': 'Гая', 'Gordana': 'Гордана', 'Hana': 'Хана', 'Ilyana': 'Іляна', 'Inna': 'Інна', 'Jagoda': 'Ягода', 'Jarmila': 'Ярміла', 'Jaroslava': 'Ярослава', 'Jarosława': 'Ярослава', 'Jasna': 'Ясна', 'Jindřiška': 'Єндржішка', 'Kalina': 'Калина', 'Katya': 'Катя', 'Květa': 'Квета', 'Lada': 'Лада', 'Lejla': 'Лейла', 'Ljiljana': 'Ліліана', 'Ljubica': 'Любіца', 'Lucia': 'Лючія', 'Lyubov': 'Любов', 'Marfa': 'Марфа', 'Marina': 'Марина', 'Merima': 'Меріма', 'Mieczysława': 'М\'єчислава', 'Mila': 'Міла', 'Milada': 'Мілада', 'Milena': 'Мілена', 'Milica': 'Міліца', 'Mira': 'Мира', 'Miroslava': 'Мірослава', 'Mirosława': 'Мірослава', 'Nadezhda': 'Надія', 'Nadia': 'Надія', 'Natasha': 'Наташа', 'Nevena': 'Невена', 'Olga': 'Ольга', 'Polona': 'Полона', 'Radmila': 'Радміла', 'Radoslava': 'Радослава', 'Raisa': 'Раїса', 'Ruža': 'Ружа', 'Ružica': 'Ружіца', 'Slavena': 'Славена', 'Snežana': 'Снєжана', 'Snezhana': 'Снєжана', 'Sonia': 'Соня', 'Stanislava': 'Станіслава', 'Svetlana': 'Світлана', 'Tanya': 'Таня', 'Tasha': 'Таша', 'Věnceslava': 'Венцеслава', 'Viera': 'Вієра', 'Vlatka': 'Влатка', 'Wanda': 'Ванда', 'Yana': 'Яна', 'Yaroslava': 'Ярослава', 'Zdenka': 'Зденка', 'Zenaida': 'Зенайда', 'Zlata': 'Злата', 'Zora': 'Зора', 'Zorica': 'Зоріца', 'Zoya': 'Зоя',
        'Adam': 'Адам', 'Alexei': 'Олексій', 'Andrei': 'Андрій', 'Anton': 'Антон', 'Boris': 'Борис', 'Božidar': 'Божидар', 'Branimir': 'Бранімір', 'Branislav': 'Браніслав', 'Bronislav': 'Броніслав', 'Cyril': 'Костянтин', 'Damian': 'Даміан', 'Darko': 'Дарко', 'David': 'Давид', 'Dimitri': 'Дмитрій', 'Dobromir': 'Добромир', 'Dragoslav': 'Драгослав', 'Filip': 'Філіп', 'František': 'Франтішек', 'Goran': 'Горан', 'Grzegorz': 'Ґжеґорж', 'Igor': 'Ігор', 'Janko': 'Янко', 'Jaroslav': 'Ярослав', 'Jiří': 'Єрі', 'Jozef': 'Йозеф', 'Juraj': 'Юрій', 'Karel': 'Карел', 'Konstantin': 'Костянтин', 'Ladislav': 'Ладислав', 'Luka': 'Лука', 'Lukáš': 'Лукаш', 'Marcin': 'Марчін', 'Marek': 'Марек', 'Marian': 'Маріан', 'Matěj': 'Матій', 'Matúš': 'Матуш', 'Mihajlo': 'Михайло', 'Milan': 'Мілан', 'Miloš': 'Мілош', 'Miroslav': 'Мірослав', 'Mladen': 'Младен', 'Nikola': 'Микола', 'Ondrej': 'Ондрей', 'Oleg': 'Олег', 'Pavel': 'Павло', 'Peter': 'Петро', 'Radomir': 'Радомир', 'Radovan': 'Радован', 'Ratko': 'Ратко', 'Roman': 'Роман', 'Rostislav': 'Ростислав', 'Stanislav': 'Станіслав', 'Stefan': 'Степан', 'Tomáš': 'Томаш', 'Valentin': 'Валентин', 'Václav': 'Вацлав', 'Vasil': 'Василь', 'Vlastimil': 'Владислав', 'Vladimir': 'Володимир', 'Vojtěch': 'Войтєх', 'Yuri': 'Юрій', 'Zdeněk': 'Зденек', 'Željko': 'Желько', 'Anatoly': 'Анатолій', 'Danylo': 'Данило', 'Fedir': 'Федір', 'Hennadiy': 'Геннадій', 'Heorhiy': 'Георгій', 'Herman': 'Герман', 'Hlib': 'Гліб', 'Hryhoriy': 'Григорій', 'Kyrylo': 'Кирило', 'Leonid': 'Леонід', 'Lyubomir': 'Любомир', 'Milovan': 'Мілован', 'Musiy': 'Мусій', 'Mykhailo': 'Михайло', 'Mykyta': 'Микита', 'Myron': 'Мирон', 'Myroslav': 'Мирослав', 'Nectarios': 'Нектарій', 'Neven': 'Невен', 'Nikita': 'Нікіта', 'Oles': 'Олесь', 'Panteleimon': 'Пантелеймон', 'Pavsikakiy': 'Павсикакій', 'Petro': 'Петро', 'Pinkhus': 'Пінхус', 'Pylyp': 'Філіп', 'Ratimir': 'Ратимир', 'Severyn': 'Северин', 'Slava': 'Слава', 'Sobieslaw': 'Собіслав', 'Stanimir': 'Станімір', 'Stepan': 'Степан', 'Sviatoslav': 'Святослав', 'Symon': 'Симон', 'Vadym': 'Вадим', 'Valentyn': 'Валентин', 'Veniamin': 'Веніамін', 'Veselin': 'Веселін', 'Victor': 'Віктор', 'Vitalii': 'Віталій', 'Vitomir': 'Вітомир', 'Vsevolod': 'Всеволод', 'Vukašin': 'Вукашин', 'Vukmir': 'Вукмір', 'Vyacheslav': 'В\'ячеслав', 'Yakiv': 'Яків', 'Yarko': 'Ярко', 'Yegor': 'Єгор', 'Yevgen': 'Євген', 'Yevhen': 'Євген', 'Yukhym': 'Юхим', 'Yury': 'Юрій', 'Ahafiia': 'Агафія', 'Anhelina': 'Ангеліна', 'Anzhelika': 'Анжеліка', 'Ariadna': 'Аріадна', 'Bilooka': 'Білоока', 'Bohdana': 'Богдана', 'Chrystia': 'Христа', 'Daiana': 'Даяна', 'Dariia': 'Дарія', 'Darija': 'Дарія', 'Halyna': 'Галина', 'Irena': 'Ірина', 'Kalyna': 'Калина', 'Kekyliia': 'Кекилія', 'Kira': 'Кіра', 'Klymentyna': 'Клементина', 'Kvitoslava': 'Квітослава', 'Larysa': 'Лариса', 'Lesia': 'Лесія', 'Lidiia': 'Лідія', 'Liubov': 'Любов', 'Liudmyla': 'Людмила', 'Maiia': 'Майя', 'Maryna': 'Марина', 'Motrona': 'Мотрона', 'Mykhailyna': 'Михайліна', 'Myroslava': 'Мірослава', 'Nadiia': 'Надія', 'Nadiya': 'Надія', 'Natalka': 'Наталка', 'Neonila': 'Неоніла', 'Oleksandra': 'Олександра', 'Olesia': 'Олесія', 'Olha': 'Ольга', 'Oresta': 'Ореста', 'Orysia': 'Орися', 'Ruslana': 'Русалана', 'Serafima': 'Серафіма', 'Severyna': 'Северина', 'Stefaniia': 'Стефанія', 'Svitlana': 'Світлана', 'Teodoziia': 'Теодозія', 'Valentyna': 'Валентина', 'Valeryya': 'Валерія', 'Vasylyna': 'Василіна', 'Vira': 'Віра', 'Volodymyra': 'Володимира', 'Vozna': 'Візна', 'Vytvytska': 'Витвицька', 'Yanina': 'Яніна', 'Yaryna': 'Ярина', 'Yevdokiia': 'Євдокія', 'Yevheniia': 'Євгенія', 'Zinaida': 'Зінаїда',
    },
        ...
        async initializeTranslitMap() {
            ...
            { title: "Кінець дня питань 0", text: "Мій робочий день вже закінчується, тому якщо у вас з'являться додаткові питання — мої колеги постараються відповісти до кінця робочого дня. Якщо через велику кількість звернень це не вдасться, ми обов’язково повернемось до вас завтра з 9:00 ранку 🙏\n\nСподіваюсь на ваше розуміння та гарного вам вечора 🙂", category: "Завершення дня", images: [] },

            // Прощання
            { title: "Прощання стандарт", text: "Дякую за звернення у службу підтримки KeyCRM! locksmith\nБудемо раді поспілкуватися знову💙\n\nГарного дня😊", category: "Прощання", images: [] },
            { title: "Прощання без відповіді", text: "Дякую за звернення у службу підтримки KeyCRM! locksmith\nНе отримали відповіді від вас😭\nБудемо раді поспілкуватися знову💙\n\nГарного дня😊", category: "Прощання", images: [] },
            { title: "Прощання питань нема", text: "Дякую за звернення у службу підтримки KeyCRM! locksmith\nБачу що додаткових питань не виникло.\nБуду радий поспілкуватися знову💙\n\nГарного дня😊", category: "Прощання", images: [] },

            // Уточнення
            { title: "(bye) уточнення 2", text: "У вас є додаткові запитання, з якими я можу вам допомогти?", category: "Уточнення", images: [] },
            { title: "ТУТ", text: "Схоже, що ви відлучились на деякий час. Ви все ще тут?", category: "Уточнення", images: [] },

            // Авторизація
            { title: "Авторизація ІНСТ", text: "Канал комунікацій Instagram автоматично вимикається лише в одному випадку — якщо Facebook відбирає доступ у нашої системи, який ви надавати під час авторизації до акаунта Instagram 🥺\n\nПричин для цього існує кілька, з їх детальним описом можна ознайомитись за посиланням:\nhttps://help.keycrm.app/uk/communication-channels/difficulty-connecting-to-instagram#disconnection\n\nДля того, щоб виправити цю ситуацію — необхідно оновити доступ шляхом повторної авторизації. \n\nДля цього відкрийте редагування потрібного каналу комунікацій (значок олівця) — натисніть на «Continue with Facebook», після чого оберіть \"Змінити попередні налаштування\", щоб переконатись в коректності попередніх налаштувань (активовані дозволи до потрібної сторінки та instagram акаунта):\nhttps://ucarecdn.com/0b9134f6-37aa-472b-a774-5fc1df10df54/image.png\n\nПісля проходження повторної авторизації необхідно обов'язково зберегти канал комунікацій. \n\nДодатково звертаємо увагу, що повідомлення які вам надходили під час того, коли канал не працював — на жаль, вже не підтягнуться, тому його роботу необхідно перевірити завдяки саме новим повідомленням 👌", category: "Авторизація", images: [] },

            // Часові вікна
            { title: "Часові вікна", text: "Ця помилка з’являється, коли Facebook обмежує можливість відповісти клієнту. Це відбувається, якщо з моменту останньої активності в чаті минуло більше 24 годин для тригерних  повідомлень або 7 днів для повідомлень, які відправляються вручу.\n\nЦе обмеження встановлене самою платформою, і ми, на жаль, не можемо на нього вплинути 🥺\n\nПроте в нашій інструкції ми детально описали всі нюанси цього правила, та що можна зробити в цій ситуації:\nhttps://help.keycrm.app/uk/communication-channels/chasovi-vikna-vidpovidiei-u-facebook-ta-instagram\n\nЯкщо у вас будуть додаткові питання, ми завжди готові допомогти! 🙂", category: "Часові вікна", images: [] },

            // ФОП
            { title: "ФОП 1", text: "Ми надаємо можливість оплатити CRM на розрахунковий рахунок нашого ФОПа (не платника ПДВ). У цьому разі діють наступні умови:\n- рахунок можна виставити на суму від $200 (в еквіваленті);\n- рахунок готується протягом 1 робочого дня після отримання потрібних даних;\n- кошти зараховуються протягом 1 робочого дня з моменту їх надходження на наш рахунок;\n- акти надсилаються через сервіс \"Вчасно\", на суму оплати — наступного місяця після неї (крім ФОПів);\n- бонуси за оплату в цьому випадку не нараховуються.\n\nЯкщо такий варіант вам підходить — підкажемо, які саме дані потрібні для формування рахунку 👌", category: "Оплата", images: [] },
            { title: "ФОП 2", text: "Щоб ми могли відправити вам рахунок для сплати, нам необхідно:\n- посилання на СРМ, в яку потрібно зарахувати оплату;\n- суму, на яку хочете поповнити баланс (мінімум $200);\n- email вашого облікового запису у системі Вчасно, на який будуть відправлятись акти;\n- назва вашої компанії, ФОП, ПП тощо;\n- ЄДРПОУ;\n- IBAN рахунку;\n- ПІБ директора;\n- юридична адреса.", category: "Оплата", images: [] },

            // Новий клієнт
            { title: "Новий клієнт", text: "Щоб ми могли підібрати спеціаліста під ваші задачі та надати максимально вичерпну консультацію, підкажіть, будь ласка:\n\n1. Чим займається ваша компанія та який тип бізнесу ви ведете? Продаж товарів, послуг чи, можливо, щось інше?\n2. О котрій годині вам буде зручно обговорити деталі?\n3. На який номер телефону ми можемо зателефонувати?\n\nЯ передам запит менеджеру, який зв'яжеться з вами та надасть відповіді на всі питання 🙌", category: "Новий клієнт", images: [] },

            // Інші
            { title: "посилання на замовлення", text: "Надайте посилання на замовлення", category: "Інше", images: [] },
            { title: "2 лінія", text: "Я передаю ваш запит колегам, які спеціалізуються саме на таких питаннях. Вони обов'язково вам допоможуть, або уточнять додаткову інформацію, яка знадобиться для відповіді 🤓\n\nТакі запити опрацьовуються по черзі та потребують більше часу для ознайомлення, тому дочекайтесь, будь ласка, зворотного зв'язку в цьому чаті 🥺", category: "Інше", images: [] },
            { title: "Час", text: "Бачу від вас інформацію, мені потрібен час, щоб все перевірити. \nЯк тільки я підготую відповідь – одразу вам напишу 🙂", category: "Інше", images: [] },
            { title: "Інтегратори", text: "Звертаємо вашу увагу на те, що ці компанії прямого відношення до KeyCRM не мають, тому нести відповідальність за них ми не можемо. Відповідно перед початком співпраці ми радимо детально обговорити з інтегратором всі нюанси, терміни, умови тощо.", category: "Інше", images: [] }
        ],
