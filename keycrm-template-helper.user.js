...
// @version      23.0
// @description  Додає 2 кастомні кнопки для вставки привітань та керування шаблонами. Розширений словник з 300+ українськими іменами.
...
(function() {
    ...
    console.log(`KeyCRM Template Helper v23.0: Скрипт запускається...`);
    ...
    const SettingsModule = {
        ...
        clientNameSelector: 'span.link.clickable, span[data-v-1d1fc49b].link.clickable, span[data-v-5b9ca00e].link.clickable',
    ...
    const TranslitModule = {
        ...
        defaultTranslitMap: {
            // === ЛАТИНИЦЯ → КИРИЛИЦЯ (Жіночі імена) ===
            ...
            'Sofiia': 'Софія', 'Sofiya': 'Софія', 'Sofia': 'Софія', 'Sophia': 'Софія',
            'Tetiana': 'Тетяна', 'Tetyana': 'Тетяна', 'Viktoriia': 'Вікторія', 'Viktoriya': 'Вікторія',
            'Victoria': 'Вікторія', 'Yuliya': 'Юлія', 'Iuliia': 'Юлія', 'Julia': 'Юлія', 'Yulia': 'Юлія',
            'Zoryana': 'Зоряна', 'Olesia': 'Олеся', 'Olesya': 'Олеся', 'Valentyna': 'Валентина',
            'Svitlana': 'Світлана', 'Svetlana': 'Світлана', 'Alla': 'Алла', 'Yana': 'Яна', 'Jana': 'Яна',
            'Olga': 'Ольга', 'Tamara': 'Тамара', 'Liudmyla': 'Людмила', 'Ludmila': 'Людмила',
            'Yevheniia': 'Євгенія', 'Evgenia': 'Євгенія', 'Larysa': 'Лариса', 'Larisa': 'Лариса',
            'Diana': 'Діана', 'Veronika': 'Вероніка', 'Veronica': 'Вероніка', 'Alina': 'Аліна',
            'Polina': 'Поліна', 'Yelyzaveta': 'Єлизавета', 'Elizaveta': 'Єлизавета', 'Elizabeth': 'Єлизавета',
            'Yaroslava': 'Ярослава', 'Oleksandra': 'Олександра', 'Alexandra': 'Олександра', 'Aleksandra': 'Олександра',
            'Angelina': 'Ангеліна', 'Emiliia': 'Емілія', 'Emilia': 'Емілія', 'Emily': 'Емілія',
            'Zlata': 'Злата', 'Eva': 'Єва', 'Milana': 'Мілана', 'Alona': 'Альона', 'Alyona': 'Альона',
            'Uliana': 'Уляна', 'Ulyana': 'Уляна', 'Bogdana': 'Богдана', 'Dana': 'Дана',
            'Taisiia': 'Таїсія', 'Taisiya': 'Таїсія', 'Myroslava': 'Мирослава', 'Miroslava': 'Мирослава',
            'Galyna': 'Галина', 'Halyna': 'Галина', 'Galina': 'Галина', 'Nina': 'Ніна',
            'Lesya': 'Леся', 'Karina': 'Каріна', 'Kamila': 'Каміла', 'Camilla': 'Каміла',
            'Valeriya': 'Валерія', 'Valeria': 'Валерія', 'Arina': 'Аріна', 'Aryna': 'Аріна',
            'Kira': 'Кіра', 'Kyra': 'Кіра', 'Maya': 'Мая', 'Maia': 'Мая', 'Melaniia': 'Меланія',
            'Melania': 'Меланія', 'Alessandra': 'Алессандра', 'Milena': 'Мілена', 'Zlata': 'Злата',
            'Violetta': 'Віолетта', 'Maryana': 'Мар\'яна', 'Marianna': 'Маріанна', 'Raisa': 'Раїса',

            // === ЛАТИНИЦЯ → КИРИЛИЦЯ (Чоловічі імена) ===
            'Andriy': 'Андрій', 'Andrii': 'Андрій', 'Andrey': 'Андрій', 'Andrew': 'Андрій',
            'Artem': 'Артем', 'Artyom': 'Артем', 'Bohdan': 'Богдан', 'Bogdan': 'Богдан',
            'Dmytro': 'Дмитро', 'Dmitro': 'Дмитро', 'Dmitry': 'Дмитро', 'Dmitriy': 'Дмитро',
            'Ivan': 'Іван', 'Maksym': 'Максим', 'Maxim': 'Максим', 'Maksim': 'Максим',
            'Mykola': 'Микола', 'Nikolay': 'Микола', 'Nazar': 'Назар', 'Oleksandr': 'Олександр',
            'Olexandr': 'Олександр', 'Alexander': 'Олександр', 'Aleksandr': 'Олександр',
            'Ostap': 'Остап', 'Rostyslav': 'Ростислав', 'Rostislav': 'Ростислав',
            'Serhiy': 'Сергій', 'Serhii': 'Сергій', 'Sergey': 'Сергій', 'Sergiy': 'Сергій', 'Serge': 'Сергій',
            'Taras': 'Тарас', 'Vasyl': 'Василь', 'Vasiliy': 'Василь', 'Basil': 'Василь',
            'Vladyslav': 'Владислав', 'Vladislav': 'Владислав', 'Volodymyr': 'Володимир',
            'Volodimir': 'Володимир', 'Vladimir': 'Володимир', 'Yuriy': 'Юрій', 'Yurii': 'Юрій',
            'Yuri': 'Юрій', 'Yury': 'Юрій', 'Viktor': 'Віктор', 'Victor': 'Віктор',
            'Petro': 'Петро', 'Petr': 'Петро', 'Peter': 'Петро', 'Pavlo': 'Павло', 'Pavel': 'Павло', 'Paul': 'Павло',
            'Mykhailo': 'Михайло', 'Mikhail': 'Михайло', 'Mihail': 'Михайло', 'Michael': 'Михайло',
            'Ihor': 'Ігор', 'Igor': 'Ігор', 'Oleg': 'Олег', 'Yevhen': 'Євген', 'Evgen': 'Євген',
            'Eugene': 'Євген', 'Roman': 'Роман', 'Valentyn': 'Валентин', 'Valentin': 'Валентин',
            'Vitaliy': 'Віталій', 'Vitalii': 'Віталій', 'Vitaly': 'Віталій',
            'Hryhoriy': 'Григорій', 'Grigoriy': 'Григорій', 'Grigory': 'Григорій', 'Gregory': 'Григорій',
            'Denys': 'Денис', 'Denis': 'Денис', 'Dennis': 'Денис', 'Kostiantyn': 'Костянтин',
            'Konstantin': 'Костянтин', 'Constantine': 'Костянтин', 'Yaroslav': 'Ярослав',
            'Stanislav': 'Станіслав', 'Stanislaw': 'Станіслав', 'Kyrylo': 'Кирило', 'Kirill': 'Кирило',
            'Cyril': 'Кирило', 'Nikita': 'Нікіта', 'Matiay': 'Матвій', 'Matvii': 'Матвій', 'Matvey': 'Матвій',
            'Matthew': 'Матвій', 'Danylo': 'Данило', 'Daniil': 'Даніїл', 'Daniel': 'Даніїл',
            'Danilo': 'Данило', 'Tymofii': 'Тимофій', 'Timofiy': 'Тимофій', 'Timothy': 'Тимофій',
            'Illia': 'Ілля', 'Ilya': 'Ілля', 'Elijah': 'Ілля', 'Oleksii': 'Олексій', 'Aleksey': 'Олексій',
            'Alexey': 'Олексій', 'Alexei': 'Олексій', 'Arsen': 'Арсен', 'Arsenii': 'Арсеній',
            'Zakhar': 'Захар', 'Mark': 'Марк', 'Marc': 'Марк', 'Vadym': 'Вадим', 'Vadim': 'Вадим',
            'Ruslan': 'Руслан', 'Anton': 'Антон', 'Anthony': 'Антон', 'Stepan': 'Степан', 'Stefan': 'Степан',
            'Borys': 'Борис', 'Boris': 'Борис', 'Georgiy': 'Георгій', 'Georgii': 'Георгій', 'George': 'Георгій',
            'Gleb': 'Гліб', 'Myroslav': 'Мирослав', 'Miroslav': 'Мирослав', 'Sviatoslav': 'Святослав',
            'Svyatoslav': 'Святослав',

            // === КИРИЛИЦЯ → КИРИЛИЦЯ (Жіночі імена - повний список) ===
            'Анастасія': 'Анастасія', 'Анна': 'Анна', 'Дарина': 'Дарина', 'Ганна': 'Ганна',
            'Ірина': 'Ірина', 'Іванна': 'Іванна', 'Катерина': 'Катерина', 'Христина': 'Христина',
            'Лідія': 'Лідія', 'Марія': 'Марія', 'Марта': 'Марта', 'Наталія': 'Наталія',
            'Оксана': 'Оксана', 'Олена': 'Олена', 'Соломія': 'Соломія', 'Софія': 'Софія',
            'Тетяна': 'Тетяна', 'Вікторія': 'Вікторія', 'Юлія': 'Юлія', 'Зоряна': 'Зоряна',
            'Олеся': 'Олеся', 'Валентина': 'Валентина', 'Світлана': 'Світлана', 'Алла': 'Алла',
            'Яна': 'Яна', 'Ольга': 'Ольга', 'Тамара': 'Тамара', 'Людмила': 'Людмила',
            'Євгенія': 'Євгенія', 'Лариса': 'Лариса', 'Діана': 'Діана', 'Вероніка': 'Вероніка',
            'Аліна': 'Аліна', 'Кристина': 'Кристина', 'Надія': 'Надія', 'Любов': 'Любов',
            'Поліна': 'Поліна', 'Єлизавета': 'Єлизавета', 'Ярослава': 'Ярослава', 'Олександра': 'Олександра',
            'Ангеліна': 'Ангеліна', 'Емілія': 'Емілія', 'Злата': 'Злата', 'Єва': 'Єва',
            'Мілана': 'Мілана', 'Альона': 'Альона', 'Уляна': 'Уляна', 'Богдана': 'Богдана',
            'Дана': 'Дана', 'Таїсія': 'Таїсія', 'Мирослава': 'Мирослава', 'Галина': 'Галина',
            'Ніна': 'Ніна', 'Леся': 'Леся', 'Каріна': 'Каріна', 'Каміла': 'Каміла',
            'Валерія': 'Валерія', 'Аріна': 'Аріна', 'Кіра': 'Кіра', 'Мая': 'Мая',
            'Меланія': 'Меланія', 'Мілена': 'Мілена', 'Віолетта': 'Віолетта', 'Мар\'яна': 'Мар\'яна',
            'Маріанна': 'Маріанна', 'Раїса': 'Раїса', 'Зінаїда': 'Зінаїда', 'Антоніна': 'Антоніна',
            'Алевтина': 'Алевтина', 'Віра': 'Віра', 'Ксенія': 'Ксенія', 'Роксолана': 'Роксолана',
            'Устина': 'Устина', 'Дарія': 'Дарія', 'Есфір': 'Есфір', 'Жанна': 'Жанна',
            'Інна': 'Інна', 'Лілія': 'Лілія', 'Майя': 'Майя', 'Марина': 'Марина',

            // === КИРИЛИЦЯ → КИРИЛИЦЯ (Чоловічі імена - повний список) ===
            'Андрій': 'Андрій', 'Артем': 'Артем', 'Богдан': 'Богдан', 'Дмитро': 'Дмитро',
            'Іван': 'Іван', 'Максим': 'Максим', 'Микола': 'Микола', 'Назар': 'Назар',
            'Олександр': 'Олександр', 'Остап': 'Остап', 'Ростислав': 'Ростислав', 'Сергій': 'Сергій',
            'Тарас': 'Тарас', 'Василь': 'Василь', 'Владислав': 'Владислав', 'Володимир': 'Володимир',
            'Юрій': 'Юрій', 'Віктор': 'Віктор', 'Петро': 'Петро', 'Павло': 'Павло',
            'Михайло': 'Михайло', 'Ігор': 'Ігор', 'Олег': 'Олег', 'Євген': 'Євген',
            'Роман': 'Роман', 'Валентин': 'Валентин', 'Віталій': 'Віталій', 'Григорій': 'Григорій',
            'Денис': 'Денис', 'Костянтин': 'Костянтин', 'Ярослав': 'Ярослав', 'Станіслав': 'Станіслав',
            'Кирило': 'Кирило', 'Нікіта': 'Нікіта', 'Матвій': 'Матвій', 'Даніїл': 'Даніїл',
            'Данило': 'Данило', 'Тимофій': 'Тимофій', 'Ілля': 'Ілля', 'Олексій': 'Олексій',
            'Арсен': 'Арсен', 'Арсеній': 'Арсеній', 'Захар': 'Захар', 'Марк': 'Марк',
            'Вадим': 'Вадим', 'Руслан': 'Руслан', 'Антон': 'Антон', 'Степан': 'Степан',
            'Борис': 'Борис', 'Георгій': 'Георгій', 'Гліб': 'Гліб', 'Мирослав': 'Мирослав',
            'Святослав': 'Святослав', 'Анатолій': 'Анатолій', 'Артур': 'Артур', 'Богуслав': 'Богуслав',
            'Борислав': 'Борислав', 'В\'ячеслав': 'В\'ячеслав', 'Гордій': 'Гордій', 'Данил': 'Данил',
            'Дмитрій': 'Дмитрій', 'Захарій': 'Захарій', 'Ілларіон': 'Ілларіон', 'Йосип': 'Йосип',
            'Кузьма': 'Кузьма', 'Лев': 'Лев', 'Леонід': 'Леонід', 'Макар': 'Макар',
            'Мстислав': 'Мстислав', 'Назарій': 'Назарій', 'Олелько': 'Олелько', 'Орест': 'Орест',
            'Пилип': 'Пилип', 'Прохор': 'Прохор', 'Родіон': 'Родіон', 'Семен': 'Семен',
            'Тимур': 'Тимур', 'Федір': 'Федір', 'Філіп': 'Філіп', 'Юліан': 'Юліан'
        },
    ...
    const GreetingModule = {
        ...
        processAndInsert() {
            ...
            // Спробувати знайти транслітерацію для кожного слова в словнику
            let foundName = null;
            ...
            // Якщо знайдено в словнику - одразу вставляємо
            if (foundInDictionary && transliterated) {
            ...
            // Якщо НЕ знайдено в словнику - шукаємо кирилічне слово для підказки
            let suggestedName = '';
            ...
            // Якщо не знайдено в словнику - показати модалку (навіть якщо є кирилиця)
            console.log(`KeyCRM Template Helper: Name "${rawFullName}" not found in dictionary, showing modal.`);
            UIModule.showNameChoice(suggestedName || words[words.length - 1] || '');
        }
    };
