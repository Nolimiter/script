...
(function() {
    ...
    console.log(`KeyCRM Template Helper v22.7: Скрипт запускається...`);
    ...
    const TranslitModule = {
        ...
        defaultTranslitMap: {
            ...
            'Julia': 'Юлія', 'Zoryana': 'Зоряна', 'Olesia': 'Олеся', 'Olesya': 'Олеся',
            'Valentyna': 'Валентина', 'Svitlana': 'Світлана', 'Alla': 'Алла', 'Yana': 'Яна',
            'Olga': 'Ольга', 'Tamara': 'Тамара', 'Liudmyla': 'Людмила', 'Yevheniia': 'Євгенія',
            'Larysa': 'Лариса', 'Diana': 'Діана', 'Veronika': 'Вероніка', 'Alina': 'Аліна',
            ...
            'Yurii': 'Юрій', 'Viktor': 'Віктор', 'Petro': 'Петро', 'Pavlo': 'Павло',
            'Mykhailo': 'Михайло', 'Ihor': 'Ігор', 'Oleg': 'Олег', 'Yevhen': 'Євген',
            'Roman': 'Роман', 'Valentyn': 'Валентин', 'Vitaliy': 'Віталій', 'Hryhoriy': 'Григорій',

            // Кирилиця → Кирилиця (жіночі імена)
            ...
            // Кирилиця → Кирилиця (чоловічі імена)
